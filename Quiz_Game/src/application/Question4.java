...
public class Question4 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		Label q4 = new Label();
		q4.setText("Q: int a=5 , b=3 , c=(++a + b--)*2+b:");
		q4.setLayoutX(100);
		q4.setLayoutY(200);
		q4.setFont(Font.font("Times New Roman", FontWeight.BOLD, FontPosture.ITALIC, 25));
		
		
		RadioButton r1 = new RadioButton("c=20");
		RadioButton r2 = new RadioButton("c=16");
		RadioButton r3 = new RadioButton("c=18");
		RadioButton r4 = new RadioButton("c=22");
		...
		Group root = new Group(header,q4,r1,r2,r3,r4,next);
        ...
        stage.setTitle("Quiz Game------>Question #4");
        stage.show();
	}
