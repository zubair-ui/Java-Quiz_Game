...
public class Question8 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		Label q8 = new Label();
		q8.setText("Q: double value=Math.rand();");
		q8.setLayoutX(100);
		q8.setLayoutY(200);
		q8.setFont(Font.font("Times New Roman", FontWeight.BOLD, FontPosture.ITALIC, 25));
		
		
		RadioButton r1 = new RadioButton("value=0.658");
		RadioButton r2 = new RadioButton("value=0.9586");
		RadioButton r3 = new RadioButton("value=Random value between 0 and 1");
		RadioButton r4 = new RadioButton("value=1");
		...
		Group root = new Group(header,q8,r1,r2,r3,r4,next);
        ...
        stage.setTitle("Quiz Game------>Question #8");
        stage.show();
	}
