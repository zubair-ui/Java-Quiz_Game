...
public class Question3 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		Label q3 = new Label();
		q3.setText("What is the correct way to Initialize an Object for Car Class?");
		q3.setLayoutX(100);
		q3.setLayoutY(200);
		q3.setFont(Font.font("Times New Roman", FontWeight.BOLD, FontPosture.ITALIC, 25));
		
		
		RadioButton r1 = new RadioButton("Car = new Car();");
		RadioButton r2 = new RadioButton("Car BMW = new Car();");
		RadioButton r3 = new RadioButton("BMW = new Car();");
		RadioButton r4 = new RadioButton("Car = BMW;");
		...
		Group root = new Group(header,q3,r1,r2,r3,r4,next);
        ...
        stage.setTitle("Quiz Game------>Question #3");
        stage.show();
	}
